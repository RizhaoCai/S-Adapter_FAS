...
class Trainer():
    ...
    def __init__(self, config):
        ...
        kwargs = {
            ...
            'super_LoRA_dim': self.config.MODEL.super_LoRA_dim,
            'super_prompt_tuning_dim': self.config.MODEL.super_prompt_tuning_dim,
            'super_adapter_dim': self.config.MODEL.super_adapter_dim,
            'super_prefix_dim': self.config.MODEL.super_prefix_dim,
        }
