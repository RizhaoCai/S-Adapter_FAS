...
_C.MODEL.CONV = 'cdc' # cdc
_C.MODEL.CDC_THETA = 0.7 # for cdc conv or cdc 5x5 unshared
_C.MODEL.ADAPTIVE_TYPE = 'learnable' # 'layer_attn' # # 'spatial_attn', 'sampling' 'spatial_att'
...
_C.TRAIN.CDC_THETA_INIT = 0.5 # if 0.0: then no contrastive_loss
